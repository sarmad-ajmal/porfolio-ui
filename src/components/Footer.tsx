...
import { Linkedin, Heart, Github, Twitter } from "lucide-react";

export function Footer() {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="relative py-12 px-6 bg-gradient-to-b from-light-bg to-light-surface dark:from-dark-bg dark:to-dark-surface border-t border-light-border/50 dark:border-dark-border/50 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          ...
          >
            <motion.a
              ...
              aria-label="LinkedIn"
            >
              <Linkedin className="w-5 h-5 text-light-text-secondary dark:text-dark-text-secondary hover:text-light-accent dark:hover:text-dark-accent transition-colors" />
            </motion.a>
            <motion.a
              ...
              aria-label="GitHub"
            >
              <Github className="w-5 h-5 text-light-text-secondary dark:text-dark-text-secondary hover:text-light-accent dark:hover:text-dark-accent transition-colors" />
            </motion.a>
            <motion.a
              ...
              aria-label="Twitter"
            >
              <Twitter className="w-5 h-5 text-light-text-secondary dark:text-dark-text-secondary hover:text-light-accent dark:hover:text-dark-accent transition-colors" />
            </motion.a>
          </motion.div>
        </div>
